 ...
 *
 */
void VBuffer::writeToIndex(void *data, int index) {
 ...
 *
 */
VkResult VBuffer::flushIndex(int index) { return flush(alignmentSize, index * alignmentSize); }
 ...
 */
VkDescriptorBufferInfo VBuffer::descriptorInfoForIndex(int index) {
 ...
 * @return VkResult of the invalidate call
 */
VkResult VBuffer::invalidateIndex(int index) {
